...
public class CalculatorClient
{
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            final paho.mqtt.examples.calculator.gen.calculator.CalculatorClient client =
                    new paho.mqtt.examples.calculator.gen.calculator.CalculatorClient(mqttClient);
    ...
    private static void publishRequest(
            paho.mqtt.examples.calculator.gen.calculator.CalculatorClient client, String input)
    {
        I32 request;
        try
        {
