...
public class PowerOfTwoProvider
{
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            final zserio.pubsub.paho.mqtt.examples.calculator.gen.calculator.PowerOfTwoProvider provider =
                    new zserio.pubsub.paho.mqtt.examples.calculator.gen.calculator.PowerOfTwoProvider(
                            mqttClient);
