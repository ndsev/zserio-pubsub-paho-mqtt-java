...
public class SquareRootOfProvider
{
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            final zserio.pubsub.paho.mqtt.examples.calculator.gen.calculator.SquareRootOfProvider provider =
                    new zserio.pubsub.paho.mqtt.examples.calculator.gen.calculator.SquareRootOfProvider(
                            mqttClient);
